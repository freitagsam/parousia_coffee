...
const BagArt = () => (
  <svg
    ...
    style={{ width: 140, position: 'relative', zIndex: 2, filter: 'drop-shadow(0 12px 28px rgba(0,0,0,.14))' }}
  >
  ...
  return (
    ...
    >
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              color: 'var(--navy-dk)',
              background: added ? '#b8e8c0' : 'var(--gold-lt)',
              padding: '.6rem 1.4rem',
              border: 'none',
              cursor: 'pointer',
      ...
      <div style={{ padding: '1.4rem 1.5rem 1.6rem' }}>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap' as const, gap: '.3rem', marginBottom: '1rem' }}>
          {coffee.pills.map(p => (
            <span
              key={p}
              style={{
